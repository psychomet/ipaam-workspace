          ...
          <Row gutter={[32, 32]}>
            ...
            <Col lg={12}>
              <Card title="ثبت چک صیادی">
                <Text>
                  ...
                  صیادی اقدام کند. به این منظور با وارد نمودن شناسه صیادی و
                  تطبیق اطلاعات خود به عنوان صادرکننده، نسبت به افزودن گیرنده یا
            ...
            <Col lg={12}>
              <Card title="دریافت چک">
                <Text>
                  پس از دریافت برگه چک از صادرکننده و مراجعه به چک صیادی، علاوه
                  بر تایید دریافت آن، از صحت اطلاعات مندرج بر روی چک، اعم از نام
