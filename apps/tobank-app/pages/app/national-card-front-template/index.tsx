...
export interface Ehraz6Props {}

export function Ehraz6(props: Ehraz6Props) {
  return (
    <>
        ...
        <Space direction={'vertical'} size={16} align={'center'}>
          ...
          <Space align={'center'}>
            <Space direction={'vertical'} align={'center'} size={10}>
              ...
              <img src="/app/Group 12658.png" className="img-fluid" alt="" />
            </Space>
          </Space>
        </Space>
          ...
          <Space align={'center'}>
            <Space direction={'vertical'} align={'center'} size={10}>
              <Space size={5} align={'center'}>
                ...
                ></div>
                <small style={{ fontSize: '10px' }}>
                  تصویر کارت ملی تار و ناخوانا نباشد
                </small>
              </Space>
              <img src="/app/Group 12657.png" className="img-fluid" alt="" />
            </Space>
          </Space>
          <Space align={'center'}>
            <Space direction={'vertical'} align={'center'} size={10}>
              ...
              <img src="/app/Group 12659.png" className="img-fluid" alt="" />
            </Space>
          </Space>
          <Space align={'center'}>
            <Space direction={'vertical'} align={'center'} size={10}>
