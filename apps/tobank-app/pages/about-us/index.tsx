            ...
            <Col flex="auto">
              <Space direction="vertical" size={16}>
                ...
                <Text className={styles.aboutus__text}>
                  ...
                  جهانی ارتقا دهد. از اهداف و چشم‌اندازهای مرکز نوآوری مالی
                  ایپام، تبدیل این شرکت به جامع‌ترین و کامل‌ترین برند تسهیل
                  کننده و ارائه‌دهنده خدمات پرداخت در سطح کشور و تبدیل به
                  بزرگ‌ترین مرکز نوآوری تخصصی کشور در حوزه صنعت بزرگ فین‌تک کشور
                  می‌باشد. این اهداف با بکارگیری نیروهای متخصص و جوان، ورود و
                  استفاده از برترین ایده‌های نوآوری در حوزه مالی کشور و تلاش
                  برای ارتقاء سطح کیفی حوزه‌های مذکور کاملا در دسترس است.{' '}
                </Text>
              </Space>
            </Col>
          </Row>
